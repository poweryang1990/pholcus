...
const (
<<<<<<< HEAD
	VERSION   string = "v0.1.1"                                      // 软件版本号
	AUTHOR    string = "J-Go"                                 // 软件作者
	NAME      string = "UOKO幽灵蛛数据采集"                              // 软件名
=======
...
func init() {
	...
	cache.Task = &cache.AppConf{
		...
		ProxySecond:    setting.DefaultInt64("run::proxysecond", proxysecond), // 代理IP更换的间隔分钟数
